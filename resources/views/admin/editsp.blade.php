        ...
        <div class="card-body card-block" style="padding-left: 150px;">
            <form action="{{URL::to('/sua-san-pham')}}" method="post" enctype="multipart/form-data" class="form-horizontal">
                ...
                <div class="row form-group">
                    ...
                    <div class="col-12 col-md-9">
                        <input type="text" id="manhinh" name="manhinh" value="{{$sp->mahinh}}" class="form-control">
                    </div>
                </div>
                <div class="row form-group">
                    <div class="col col-md-3">
                    ...
                    <div class="col-12 col-md-9">
                        <input type="text" id="ram" name="ram" value="{{$sp->ram}}" class="form-control">
                    </div>
                </div>
                <div class="row form-group">
                    <div class="col col-md-3">
                    ...
                    <div class="col-12 col-md-9">
                        <input type="text" id="pin" name="pin" value="{{$sp->pin}}" class="form-control">
                    </div>
                </div>
                <div class="row form-group">
                    <div class="col col-md-3">
                    ...
                    <div class="col-12 col-md-9">
                        <input type="text" id="camera" name="camera" value="{{$sp->camera}}" class="form-control">
                    </div>
                </div>
        <!-- <div class="row form-group">
            @for($i=1 ; $i<=10 ; $i++)
