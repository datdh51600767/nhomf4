        ...
        <div class="card-body card-block" style="padding-left: 150px;">
            <form action="{{URL::to('/save-san-pham')}}" method="post" enctype="multipart/form-data" class="form-horizontal">
                ...
                <div class="row form-group">
                    ...
                    <div class="col-12 col-md-9">
                        <input type="text" id="manhinh" name="manhinh" placeholder="" class="form-control">
                    </div>
                </div>
                <div class="row form-group">
                    <div class="col col-md-3">
                    ...
                    <div class="col-12 col-md-9">
                        <input type="text" id="ram" name="ram" placeholder="" class="form-control">
                    </div>
                </div>
                <div class="row form-group">
                    <div class="col col-md-3">
                        <label for="text-input" class=" form-control-label">PIN</label>
                    </div>
                    <div class="col-12 col-md-9">
                        <input type="text" id="pin" name="pin" placeholder="" class="form-control">
                    </div>
                </div>
                <div class="row form-group">
                    <div class="col col-md-3">
                    ...
                    <div class="col-12 col-md-9">
                        <input type="text" id="camera" name="camera" placeholder="" class="form-control">
                    </div>
                </div>
        <!-- <div class="row form-group">
            @for($i=1 ; $i<=10 ; $i++)
