					...
					<div class="get_in_touch">
						...
						<div class="contact_form_container">
							<form action="#" id="contact_form" class="contact_form">
								...
								<div>
									<!-- Subject -->
									<label for="contact_company">Danh xưng</label>
								...
								<button class="button contact_button"><span>Gữi</span></button>
							</form>
						</div>
					</div>
				</div>
				...
				<div class="col-lg-3 offset-xl-1 contact_col">
					<div class="contact_info">
						<div class="contact_info_section">
							...
							<ul>
								<li>Phone: <span>0902952591</span></li>
								<li>Email: <span>hieu.dh51600821@gmail.com</span></li>
							</ul>
						</div>
						<div class="contact_info_section">
