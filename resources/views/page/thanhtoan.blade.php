						...
						<div class="order_list_container">
							...
							<ul class="order_list">
								...
								<li class="d-flex flex-row align-items-center justify-content-start">
									...
									<div class="order_list_value ml-auto"><i style="font-size: 15px">{{$v_content->price}} VNĐ </i></div>
								...
								<li class="d-flex flex-row align-items-center justify-content-start">
									...
									<div class="order_list_value ml-auto"><b style="font-size: 16px">{{$v_content->price * $v_content->qty}} VNĐ </b></div>
								</li>
								<li class="d-flex flex-row align-items-center justify-content-start">
									<div class="order_list_title"><b style="font-size: 20px">Ship</b></div>
									<div class="order_list_value ml-auto"><b style="font-size: 16px">{{$ship}} VNĐ </b></div>
								</li>
								<li class="d-flex flex-row align-items-center justify-content-start">
									<div class="order_list_title"><b style="font-size: 20px">Tổng cộng</b></div>
									<div class="order_list_value ml-auto"><b style="font-size: 16px">{{$tong + $ship}} VNĐ</b></div>
								</li>
							</ul>
						</div>
