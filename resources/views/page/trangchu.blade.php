...
@section('content')
	...
	<div class="owl-carousel owl-theme" style="background-color: #a4b5a5;">
	    <div class="item">
	    	<img src="sublime/images/Slide/banner5.jpg" style="width: 100%;height: 100%;">	
	    </div>
	    <div class="item">
	    	<img src="sublime/images/Slide/banner6.jpg" style="width: 100%;height: 100%;">	
	    </div>
	    <div class="item">
						...
						@foreach($new_pro as $new)
							<div class="product"><a href="{{route('chitietsanpham',$new->id)}}">
								...
								<div class="product_content" align="center">
									...
									<div class="product_price">{{$new->pro_gia}}</div>
